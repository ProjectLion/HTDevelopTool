...
#import "NSString+HTDecision.h"

@implementation NSString (HTDecision)
...
- (BOOL)ht_isValidWithMinLenth:(NSInteger)minLenth
...
#pragma mark - 算法相关
//精确的身份证号码有效性检测
+ (BOOL)ht_accurateIDCard:(NSString *)value {
