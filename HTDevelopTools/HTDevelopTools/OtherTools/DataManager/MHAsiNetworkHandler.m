               ...
               failureBlock:(MHAsiFailureBlock)failureBlock
{
    ...
    self.netWorkItem = [[MHAsiNetworkItem alloc]initWithtype:networkType url:url params:params delegate:delegate target:target action:action hashValue:hashValue showHUD:toView successBlock:successBlock failureBlock:failureBlock];
